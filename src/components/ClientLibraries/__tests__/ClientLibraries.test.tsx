...
describe('ClientLibraries', () => {
    ...
    it('should navigate to the correct links on click', ()=>{
        render(<ClientLibaries />)
        expect(screen.getByText('Go to the JavaScript library').closest('a')).toHaveAttribute('href', 'https://binary-com.github.io/deriv-api/')
        expect(screen.getByText('Go to the Python library').closest('a')).toHaveAttribute('href', 'https://binary-com.github.io/python-deriv-api/')
        expect(screen.getByText('Go to the Flutter library').closest('a')).toHaveAttribute('href', 'https://github.com/deriv-com/flutter-deriv-api')
    })
